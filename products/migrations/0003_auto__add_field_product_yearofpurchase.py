...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.yearofpurchase'
        db.add_column(u'products_product', 'yearofpurchase',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.yearofpurchase'
        db.delete_column(u'products_product', 'yearofpurchase')
