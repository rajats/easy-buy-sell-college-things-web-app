...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductComment.commenter'
        db.add_column(u'products_productcomment', 'commenter',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductComment.commenter'
        db.delete_column(u'products_productcomment', 'commenter')
    ...
    models = {
        ...
        u'products.productcomment': {
            ...
            'commenter': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
