...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Orders.confirmed'
        db.add_column(u'checkout_orders', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Orders.confirmed'
        db.delete_column(u'checkout_orders', 'confirmed')
    ...
    models = {
        ...
        u'checkout.orders': {
            ...
            'buyer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_buyer'", 'to': u"orm['auth.User']"}),
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['products.Product']"}),
            'seller': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_seller'", 'to': u"orm['auth.User']"})
        },
